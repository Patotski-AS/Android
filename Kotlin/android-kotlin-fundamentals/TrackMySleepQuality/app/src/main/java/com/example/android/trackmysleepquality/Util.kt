...
/**
 * преобразовать его в красиво отформатированную строку для отображения.
 ...
 * тип Spanned, который представляет собой строку в формате HTML.
 * Это очень удобно, потому что TextView в Android может отображать базовый HTML.
