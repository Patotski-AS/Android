...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /**
         * LiveData поддерживает события жизненного цикла, поэтому вам нужно указать,
         * какой lifecycle owner  использовать. Вы делаете это в объекте привязки.
         установите lifecycle owner в binding object:
         */
